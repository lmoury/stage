 ...
 */
final class Version20190607164159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E875314441A32AC4 ON quai');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_E875314441A32AC4 ON quai (remorque_id)');
    }
}
